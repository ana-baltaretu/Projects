...
public class DetailActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items2 = res.getStringArray(R.array.items2);
        prices2 = res.getStringArray(R.array.prices2);
        descriptions2 = res.getStringArray(R.array.descriptions2);

        ItemAdapter itemAdapter = new ItemAdapter(this, items2, prices2, descriptions2);
        myListView2.setAdapter(itemAdapter);
